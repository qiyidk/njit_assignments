...
public class GetMovieList {
    ...
    public List<Movie> getCloselyMatchMovieList(String match){
        return new njit.qiyi.movieRecommendation.core.service.GetMovieList().getCloselyMatchMovieList(match);
    }
    ...
    public List<Movie> getCloselyMatchMovieList(String match, int num){
        return new njit.qiyi.movieRecommendation.core.service.GetMovieList().getCloselyMatchMovieList(match, num);
    }
    ...
    public List<Movie> getMovieList(String prefix){
        return new njit.qiyi.movieRecommendation.core.service.GetMovieList().getMovieList(prefix);
    }
    ...
    public List<Movie> getMovieList(String prefix, int num){
        return new njit.qiyi.movieRecommendation.core.service.GetMovieList().getMovieList(prefix, num);
    }
    ...
    public List<Movie> getMovieList(User user){
        return  new njit.qiyi.movieRecommendation.core.service.GetMovieList().getMovieList(user);
    }
    ...
    public List<Movie> getMovieList(User user, int num){
        return new njit.qiyi.movieRecommendation.core.service.GetMovieList().getMovieList(user, num);
    }
}
